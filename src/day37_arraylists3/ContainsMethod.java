...
public class ContainsMethod {
    public static void main(String[] args) {
        ...
        ArrayList<String> list2 = list1; // list2 points to the same object as list1
        
        ArrayList<String> months = new ArrayList<>(list1); // months points to a new object, but it has the same values as list1
